// components/dashboard/summary-modern.tsx
'use client'
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground">All time trades</div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Number of stocks per sector</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="performance" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Annual trading performance breakdown</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>When do you trade the most?</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <RadarChart data={data?.tradingPatterns?.byDayOfWeek || []}>
                    ...
                    <PolarRadiusAxis />
                    <Radar name="Trades" dataKey="count" stroke="#8B7355" fill="#8B7355" fillOpacity={0.6} />
                  </RadarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Trading frequency by month</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={data?.tradingPatterns?.byMonth || []}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Line type="monotone" dataKey="count" stroke="#8B7355" strokeWidth={2} dot={{ fill: '#8B7355' }} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
        ...
        <TabsContent value="holdings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed breakdown of all your stock positions</CardDescription>
            </CardHeader>
            <CardContent>
