      ...
      <div className="flex flex-wrap gap-1">
        {sortedAndFilteredStocks.map((stock) => (
          <Button
            ...
            variant="outline"
            className={cn(
              "h-6 w-24 px-1.5 py-0.5 rounded-sm flex items-center justify-center transition-all relative overflow-hidden font-normal text-[10px] leading-none shrink-0",
